 ...
 * 
 * <P>
 * The "environment" that Selenium see is '/'-separated list of labels for the slave (like /a/b/c/d), and we match incoming label to determine the
 * {@link RemoteControlProxy}.
 * 
